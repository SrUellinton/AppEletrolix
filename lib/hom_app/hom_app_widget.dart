...
import 'hom_app_model.dart';
export 'hom_app_model.dart';

class HomAppWidget extends StatefulWidget {
  const HomAppWidget({Key? key}) : super(key: key);

  @override
  _HomAppWidgetState createState() => _HomAppWidgetState();
}

class _HomAppWidgetState extends State<HomAppWidget> {
  late HomAppModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomAppModel());
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Pesquise o eco-ponto',
